...
\date[10.07.2012]{Stand: 10. Juni 2012}
...
\begin{frame}{Lizenz}
    ...
    \begin{itemize}
        ...
        \item Seit Juli 2012: ODbL\footnote<2->{Open Database License}
    \end{itemize}
...
\notepage{
    ...
    Dieser Bot war zum geplanten Zeitpunkt allerdings noch nicht fertig. Zwar gab es schon erste Ergebnisse, allerdings schlugen noch einige Tests fehl. Erst im Juli 2012 waren alle Tests erfolgreich, sodass der Bot ab dem 11. Juli 2012 arbeitete. %TODO
